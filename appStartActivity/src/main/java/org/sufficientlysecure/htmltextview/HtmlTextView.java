...
public class HtmlTextView extends JellyBeanSpanFixTextView {
	 ...
	 */
	public void setHtmlFromRawResource(Context context, int resId,
			ImageGetter imageGetter) {
		// load html from html file from /res/raw
		InputStream inputStreamText = context.getResources().openRawResource(
				resId);
	...
	public void setHtmlFromString(String html, ImageGetter imageGetter) {
		...
		// make links work
		setMovementMethod(LocalLinkMovementMethod.getInstance(getContext()));
