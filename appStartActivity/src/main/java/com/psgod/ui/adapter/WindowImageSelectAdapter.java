...
public class WindowImageSelectAdapter extends RecyclerView.Adapter<WindowImageSelectAdapter.ViewHolder> {
    private final static String TAG = WindowImageSelectAdapter.class
            .getSimpleName();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.item_select_image, parent,
                false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        if(position == 0){
            holder.image.setImageResource(R.drawable.ic_take_photo);
    ...
    public WindowImageSelectAdapter(Context context) {
        mContext = context;
        mInflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mItemLayoutParams = new GridView.LayoutParams(
                Utils.dpToPx(context,135), Utils.dpToPx(context,180));
    }
