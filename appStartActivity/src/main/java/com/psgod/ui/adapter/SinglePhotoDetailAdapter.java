...
//			viewHolder.mCommentTv.setText(sb);
    ...
    private View getCommentView() {
        ...
        textView.setText(String.format("评论  (%s)", String.valueOf(mPhotoItem.getCommentCount())));
        textView.setPadding(Utils.dpToPx(mContext, 14), Utils.dpToPx(mContext, 10),
                0, Utils.dpToPx(mContext, 10));
        textView.setCompoundDrawablesWithIntrinsicBounds(
                mContext.getResources().getDrawable(R.mipmap.ic_comment_new), null, null, null
        );
        textView.setCompoundDrawablePadding(Utils.dpToPx(mContext, 6));
        textView.setTextColor(Color.parseColor("#66000000"));
        textView.setTextSize(12);
        View view = new View(mContext);
        LinearLayout.LayoutParams vParams = new LinearLayout.
                LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                Utils.dpToPx(mContext, 0.5f));
        vParams.setMargins(Utils.dpToPx(mContext, 14), 0, Utils.dpToPx(mContext, 14), 0);
    ...
    private View getAllCommentView() {
        ...
        textView.setPadding(0, Utils.dpToPx(mContext, 15), 0, Utils.dpToPx(mContext, 30));
