...
public class RecentPageWorksFragment extends BaseFragment implements Callback {
	private static final String TAG = RecentPageWorksFragment.class
			.getSimpleName();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mViewHolder.mView = LayoutInflater.from(mContext).inflate(
				R.layout.fragment_homepage_recent, parentView, true);
		mViewHolder.mPhotoListView = (PullToRefreshListView) mViewHolder.mView
				.findViewById(R.id.fragment_homepage_recent_lv);
		mEmptyView = mViewHolder.mView
				.findViewById(R.id.fragment_homepage_recent_emptyview);
