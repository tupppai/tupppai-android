...
public class LoginActivity extends PSGodBaseActivity implements
	...
	private Listener<QQLoginWrapper> qqAuthListener = new Listener<QQLoginRequest.QQLoginWrapper>() {
	...
	private void initEvents() {
		...
		// 微信授权回调
		final Listener<WechatUserWrapper> wechatAuthListener = new Listener<WechatUserWrapper>() {
			@Override
