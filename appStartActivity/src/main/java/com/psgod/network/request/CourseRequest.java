 ...
 */
public class CourseRequest extends BaseRequest<Channel> {
    private final static String TAG = CourseRequest.class.getSimpleName();

    public CourseRequest(int method, String url, Response.Listener<Channel> listener, Response.ErrorListener errorListener) {
