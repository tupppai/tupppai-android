...
/**
 * A {@link android.os.Parcelable} implementation that should be used by
 * inheritance hierarchies to ensure the state of all classes along the chain is
 * saved.
 */
public abstract class ClassLoaderSavedState implements Parcelable {
	...
	/**
	 * Constructor called by derived classes when creating their ListSavedState
	 * objects
	 * 
	 * @param superState
	 *            The state of the superclass of this view
	 */
	protected ClassLoaderSavedState(Parcelable superState,
	...
	public static final Parcelable.Creator<ClassLoaderSavedState> CREATOR = new Parcelable.Creator<ClassLoaderSavedState>() {
