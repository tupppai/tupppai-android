 ...
 */
public class HotWaterFallItemView extends RelativeLayout {
    ...
    public HotWaterFallItemView(Context context) {
        super(context);
        mContext = context;
    }

    public HotWaterFallItemView(Context context, AttributeSet attribute) {
        this(context, attribute, 0);
        mContext = context;
    }

    public HotWaterFallItemView(Context context, AttributeSet attrs,
                                  int defStyle) {
