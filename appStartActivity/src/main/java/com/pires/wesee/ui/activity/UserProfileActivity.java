...
import com.pires.wesee.network.request.UserDetailRequest.UserDetailResult;
...
//							.getTranslationY(mLinearHeader)));
        if (isFirst) {
            ...
            isFirst = false;
                ...
                (position == 0) {
            mLinearHeader.setY(pageY0);
        } else {
            mLinearHeader.setY(pageY1);
//				ViewHelper.setTranslationY(mLinearHeader, pageY1);
        }
