	...
	private Listener<Boolean> weiboBindListener = new Listener<Boolean>() {
		...
		public void onResponse(Boolean response) {
			if (response) {
				...
				editor.putBoolean(LoginUser.SPKey.IS_BOUND_WEIBO, true);
				editor.commit();
			...
			if (response) {
				...
				SharedPreferences.Editor editor = PSGodApplication
						...
						.getSharedPreferences(
								Constants.SharedPreferencesKey.NAME,
								Context.MODE_PRIVATE).edit();
				editor.putBoolean(LoginUser.SPKey.IS_BOUND_WEIBO, false);
				editor.commit();
			...
			if (response) {
				...
				SharedPreferences.Editor editor = PSGodApplication
						...
						.getSharedPreferences(
								Constants.SharedPreferencesKey.NAME,
								Context.MODE_PRIVATE).edit();
				editor.putBoolean(LoginUser.SPKey.IS_BOUND_WECHAT, false);
				editor.commit();
			...
			if (response) {
				...
				SharedPreferences.Editor editor = PSGodApplication
						...
						.getSharedPreferences(
								Constants.SharedPreferencesKey.NAME,
								Context.MODE_PRIVATE).edit();
				editor.putBoolean(LoginUser.SPKey.IS_BOUND_QQ, true);
				editor.commit();
			...
			if (response) {
				...
				SharedPreferences.Editor editor = PSGodApplication
						...
						.getSharedPreferences(
								Constants.SharedPreferencesKey.NAME,
								Context.MODE_PRIVATE).edit();
				editor.putBoolean(LoginUser.SPKey.IS_BOUND_QQ, false);
				editor.commit();
