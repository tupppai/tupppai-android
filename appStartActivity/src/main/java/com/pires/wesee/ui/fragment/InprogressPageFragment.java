...
import com.pires.wesee.ui.adapter.InprogressPageAdapter;
...
//        parentview.addView(mViewHolder.mView);
    ...
    private void initCursor() {
        ...
        mCurSorOffset = ((Constants.WIDTH_OF_SCREEN - Utils.dpToPx(getActivity(), 80)) / 2 - mCursorWidth) / 2;
        mCursorone = mCurSorOffset * 2 + mCursorWidth;
        mCursortwo = mCursorone * 2;
//		Matrix matrix = new Matrix();
//		matrix.setTranslate(mCurSorOffset, 0);
        mViewHolder.mCursor.setX(mCurSorOffset + Utils.dpToPx(getActivity(), 40));
    }
