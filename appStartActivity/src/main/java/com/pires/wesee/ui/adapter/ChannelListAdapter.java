...
public class ChannelListAdapter extends BaseAdapter {
    ...
    public ChannelListAdapter(Context context, PhotoItemView.PhotoListType photoListType,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (type == 0 && convertView instanceof PhotoItemView) {
            ...
            if ((mPhotoListType == PhotoItemView.PhotoListType.RECENT_REPLY)
                    || (mPhotoListType == PhotoItemView.PhotoListType.SINGLE_ASK)
                    || (mPhotoListType == PhotoItemView.PhotoListType.SINGLE_REPLY)) {
                photoItemView.initialize(mPhotoListType);
