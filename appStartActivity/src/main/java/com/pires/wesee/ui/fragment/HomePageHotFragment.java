...
import com.pires.wesee.model.BannerData;
import com.pires.wesee.model.PhotoItem;
import com.pires.wesee.model.Tupppai;
import com.pires.wesee.network.request.HomePageGetBannerRequest;
        ...
        if (mSize > 0) {
            for (int i = 0; i < mSize; i++) {
                ...
                LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
                        com.pires.wesee.Utils.dpToPx(mContext, 84), com.pires.wesee.Utils.dpToPx(mContext, 84));
                params.setMargins(com.pires.wesee.Utils.dpToPx(mContext, 10), 0, 0, 0);
        ...
        for (int i = 0 ,length = mBannerItems.size(); i < length; i++) {
            ...
            bannerImage.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View arg0) {
                    com.pires.wesee.Utils.skipByUrl(getActivity(),bannerData.getUrl(),bannerData.getDesc());
                }
            });
