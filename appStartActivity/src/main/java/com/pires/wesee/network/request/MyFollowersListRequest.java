...
public class MyFollowersListRequest extends BaseRequest<List<User>> {
	private final static String TAG = MyFollowersListRequest.class
			.getSimpleName();

	public MyFollowersListRequest(int method, String url,
	...
	public static class Builder implements IGetRequestBuilder {
		...
		public MyFollowersListRequest build() {
			String url = createUrl();
			MyFollowersListRequest request = new MyFollowersListRequest(METHOD,
