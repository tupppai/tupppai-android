...
public class WheelView extends View {
	...
	/**
	 * 整个选择器的height Calculates desired height for layout
	 * 
	 * @param layout
	 *            the source layout
	...
	/**
	 * 单个选项的height Returns height of wheel item
	 * 
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.color_959595));
		// 设置线宽
