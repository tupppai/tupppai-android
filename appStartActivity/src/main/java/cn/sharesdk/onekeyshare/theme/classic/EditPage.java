...
//		rlPage.addView(new View(getContext()));
	...
	private LinearLayout getMainBody() {
		...
		LayoutParams lpMain = new LayoutParams(android.view.ViewGroup.LayoutParams.MATCH_PARENT,
		...
		LayoutParams lpContent = new LayoutParams(android.view.ViewGroup.LayoutParams.MATCH_PARENT,
				android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
		lpContent.weight = 1;
		...
		LayoutParams lpEt = new LayoutParams(android.view.ViewGroup.LayoutParams.WRAP_CONTENT,
				android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
		lpEt.weight = 1;
...
//		etContent.setFocusableInTouchMode(false);
	...
	private LinearLayout getBodyBottom() {
		...
		llBottom.setLayoutParams(new LayoutParams(android.view.ViewGroup.LayoutParams.MATCH_PARENT,
				android.view.ViewGroup.LayoutParams.WRAP_CONTENT));
		...
		LayoutParams lpCounter = new LayoutParams(android.view.ViewGroup.LayoutParams.WRAP_CONTENT,
				android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
	...
	private LinearLayout getAtLine(String platform) {
		...
		LayoutParams lpAt = new LayoutParams(android.view.ViewGroup.LayoutParams.WRAP_CONTENT,
				android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
		...
		tvName.setText(text);
		LayoutParams lpName = new LayoutParams(android.view.ViewGroup.LayoutParams.WRAP_CONTENT,
				android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
	...
	private View getSep() {
		...
		LayoutParams lpSep = new LayoutParams(android.view.ViewGroup.LayoutParams.MATCH_PARENT, dp_1);
	...
	private LinearLayout getPlatformList() {
		...
		LayoutParams lpTb = new LayoutParams(android.view.ViewGroup.LayoutParams.MATCH_PARENT,
				android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
		...
		LayoutParams lpShareTo = new LayoutParams(android.view.ViewGroup.LayoutParams.WRAP_CONTENT,
				android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
		...
		LayoutParams lpSv = new LayoutParams(android.view.ViewGroup.LayoutParams.WRAP_CONTENT,
				android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
