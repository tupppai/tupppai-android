...
public class PlatformGridViewAdapter extends BaseAdapter implements
	...
	public View getView(int position, View view, ViewGroup viewGroup) {
		...
		if (view == null) {
			view = LayoutInflater.from(context).inflate(
					getLayoutRes(context, "skyblue_share_platform_list_item"),
					null);
		...
		String checkedResName = directOnlyPosition != -1
				&& directOnlyPosition != position ? "skyblue_platform_checked_disabled"
				: "skyblue_platform_checked";
	...
	private String getName(Platform plat) {
		...
		int resId = cn.sharesdk.framework.utils.R.getStringRes(context,
				plat.getName());
		if (resId > 0) {
