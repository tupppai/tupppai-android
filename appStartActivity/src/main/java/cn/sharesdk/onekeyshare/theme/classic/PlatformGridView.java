...
public class PlatformGridView extends LinearLayout implements OnClickListener,
	...
	private void init(final Context context) {
		...
		pager.setLayoutParams(new LayoutParams(android.view.ViewGroup.LayoutParams.MATCH_PARENT,
	...
	public void afterPlatformListGot() {
		...
		LayoutParams lpLl = new LayoutParams(android.view.ViewGroup.LayoutParams.WRAP_CONTENT,
				android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
	...
	private static class GridView extends LinearLayout {
		...
		private LinearLayout getView(int position, OnClickListener ocL,
			...
			LayoutParams lpIv = new LayoutParams(android.view.ViewGroup.LayoutParams.WRAP_CONTENT,
					android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
			...
			LayoutParams lpTv = new LayoutParams(android.view.ViewGroup.LayoutParams.WRAP_CONTENT,
					android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
